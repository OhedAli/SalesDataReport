...
class DashboardController extends Controller
{
    public function index(Request $request){
        ...
        $result['weekly_details'] = Saleslogs::select('salesman', Saleslogs::raw('count(salesman) as sales_count '))
        ...
        $result['monthly_details'] =  Saleslogs::select('salesman',Saleslogs::raw('count(salesman) as sales_count '))
