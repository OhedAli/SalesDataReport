...
{
    public function index(Request $request, $date_range, $file_type, $tab_type, $pifs_check)
    {
    	...
    	return Excel::download(new SalesLogsExport($start_range,$end_range,$tab_type,$pifs_check),$export_file_name);
    }
}
