    ...
    <div class="slim-footer">
      <div class="container">
        <p>Copyright <?php echo date('Y'); ?> &copy; All Rights Reserved. Slim Dashboard Template</p>
    ...
    <script src="{{asset('app/lib/chartist/js/chartist.js')}}"></script>
    <script src="{{asset('app/lib/d3/js/d3.js')}}"></script>
    <script src="{{asset('app/lib/rickshaw/js/rickshaw.min.js')}}"></script>
    <script src="{{asset('app/lib/jquery.sparkline.bower/js/jquery.sparkline.min.js')}}"></script>
