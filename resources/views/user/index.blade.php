              ...
              @foreach($users as $key=>$user)
                <tr>
                  ...
                  <td>@if(Auth::user()->id != $user->id)
                            <a href="{{ route('user.edit', [$user->id]) }}" class="btn btn-outline-primary edit-btn">Edit</a>
                            <button data-toggle="modal" data-target="#deleteModal" class="btn btn-outline-danger delete-btn" data-route="{{ route('user.destroy', [$user->id]) }}">Delete</button>
                            @else
                            <a href="{{ route('user.edit', [$user->id]) }}" class="btn btn-outline-primary edit-btn">Edit</a>
                            @endif
                  </td>
